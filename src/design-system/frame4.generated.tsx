...
export const Frame4Generated: React.FC<{}> = observer(props => {
  return (
    <>
      ...
      <style jsx>{`
        ...
        .figma-26 {
          ...
          margin-bottom: 415px;
          min-height: 225px;
          background: url(/images/18-3.png) center center no-repeat;
        ...
        .figma-39 {
          ...
          margin-bottom: -90px;
          min-height: 493px;
          background: url(/images/18-2.png) center center no-repeat;
          background-size: cover;
        }
        .figma-40 {
          position: absolute;
